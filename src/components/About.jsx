    ...
    <div id="about" className="bg-[#ffffff] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed">
          I’m <span className="font-bold text-[#fe5617]">Naresh</span>,
          a passionate Frontend Developer with a strong focus on designing responsive and user-centered web experiences. As a recent graduate, I have completed three diverse projects, including
          <span className="font-bold text-[#fe5617]"> medical website, a menswear store, and a flight booking application</span>,
          demonstrating my capability to integrate creativity with contemporary web technologies. I hold a Bachelor of Commerce degree and
          <span className="font-bold text-[#fe5617]">  successfully completed a frontend development course at an institution in-Login 360.</span>
          I am motivated to contribute meaningfully to the technology industry.
        </p>
